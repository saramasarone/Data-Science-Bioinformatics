...
############# tximport covid ###########
clin <-fread("/Users/smasarone/Documents/kallisto/output_gen_data/sorted_folders_covid.txt")
dir <-file.path("/Users/smasarone/Documents/kallisto/output_gen_data")
